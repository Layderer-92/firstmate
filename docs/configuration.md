...
FM_COCKPIT_OBSERVATION_MAX_BYTES=65536   # maximum accepted bytes for the redacted state/cockpit-observation.json reader; the canonical private projection input keeps its existing home-summary bounds; invalid or zero values use 65536
